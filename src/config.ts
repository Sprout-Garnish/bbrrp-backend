...
export const DATABASE_URL = encodeURIComponent(
  `postgres://${process.env.RDS_USERNAME}:${process.env.RDS_PASSWORD}@${process.env.RDS_HOSTNAME}:${process.env.RDS_PORT}/bbrrp-backend`
);
